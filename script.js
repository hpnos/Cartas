...
const imagens = [
  ...
  "images/49 yuk.png", // Adicionado para pré-carregamento
  "images/50 magik.png",
  "images/21 Dogou.png",
  "images/38 ravel.png",
  "images/41 loki.png",
...
const sounds = {
  ...
  "images/49 yuk.png": new Audio("sounds/49.mp3"), // Adicionado som para a carta yuk.png
...
const rewardPool = [
  ...
  { image: "images/36 ariana.png", chance: 4.05 },
  { image: "images/44 morgan.png", chance: 4.05 },
  { image: "images/42 syivie.png", chance: 4.74 },

  // Incomuns (26,72% no total → 9 recompensas)
  ...
  // Raras (16,40% no total → 6 recompensas) – redistribuídas
  { image: "images/31 venenoso.png", chance: 2.75 },
  { image: "images/45 shogun.png", chance: 2.75 },
  { image: "images/47 galacta.png", chance: 2.75 },
  { image: "images/48 agatha.png", chance: 2.70 },
  { image: "images/49 yuk.png", chance: 2.70 },
  { image: "images/50 magik.png", chance: 2.75 },

  // Lendárias (1,30% no total → 3 recompensas)
  { image: "images/21 Dogou.png", chance: 0.30 },
  { image: "images/38 ravel.png", chance: 0.30 },
  { image: "images/41 loki.png", chance: 0.70 }, // Um pouco mais para somar os 1,30%
];
...
const modalContent = document.querySelector("#reward-modal .modal-content"); // Obter a referência uma vez aqui
...
for (let i = 0; i < 20; i++) {
  ...
  card.addEventListener("click", function handleClick() {
    ...
    setTimeout(() => {
      ...
      // AQUI ESTÁ A MUDANÇA:
      // Em vez de card.remove();
      card.style.visibility = "hidden"; // Torna a carta invisível
      cardInner.innerHTML = ''; // Limpa o conteúdo interno da carta (frente e verso)

      document.getElementById("reward-image").innerHTML = `<img src="${reward.image}" alt="Recompensa">`;
      document.getElementById("reward-modal").style.display = "flex";

      // Garante que a animação seja reproduzida a cada clique da carta
...
// Lógica para o botão de carta especial
document.getElementById("btn-carta-especial").addEventListener("click", () => {
  ...
  // gameBoard.style.display = "none"; // <<<<<< LINHA REMOVIDA
...
// Lógica para o novo botão de mostrar carta específica (Yuk)
document.getElementById("btn-show-yuk-card").addEventListener("click", () => {
  const modal = document.getElementById("reward-modal");
  const rewardImage = document.getElementById("reward-image");

  // Define a imagem específica que você quer mostrar
  ...
  // Toca o som para a carta "yuk.png" se existir
